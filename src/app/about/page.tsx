...
export default async function About() {
  ...
  return (
    <Layout>
      ...
      <section id="vision" className="pt-16 pb-16 bg-cream text-forest">
        <div className="container max-w-screen-xl mx-auto px-4">
          <h2 className="text-forest uppercase tracking-wider font-semibold text-center mb-12">
            Our Vision
          </h2>
          <div className="prose mx-auto text-forest">
            <p className="text-center text-xl">
              We envision a world where every nonprofit organization has the tools and strategies 
              they need to build meaningful, lasting relationships with their donors and supporters.
            </p>
          </div>
        </div>
      </section>
